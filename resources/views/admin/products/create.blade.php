        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price') }}" required min="1" step="1"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="stock" id="stock" value="{{ old('stock') }}" required min="1" step="1"
                    class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 text-sm font-semibold transition-colors duration-200 shadow-sm cursor-pointer">Add Product</button>
            </div>
        </form>
    </div>
